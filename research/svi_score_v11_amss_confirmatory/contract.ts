export const V11_AMSS_CONFIRMATORY_VERSION =
  "flux-svi-score-v11-amss.1.0.0-fresh-confirmatory";

export const V11_AMSS_CONFIRMATORY_CHANNELS = [
  "meta_acquisition_spend",
  "google_search_nonbrand_spend",
  "ctv_spend",
] as const;

export const V11_AMSS_CONFIRMATORY_EVIDENCE_GROUPS = [
...
export const V11_AMSS_CONFIRMATORY_MODULE_ORDERS = [
...
export const V11_AMSS_CONFIRMATORY_DECISION_SCENARIOS = [
  {
    id: "budget-reduction",
...
export const V11_AMSS_CONFIRMATORY_CONTRACT = {
  version: V11_AMSS_CONFIRMATORY_VERSION,
  purpose:
    "fresh confirmatory external-transport audit of the frozen V11 evidence-adaptive RegretSet-MMM selector in Google AMSS",
  cohort: {
    businesses: 100,
    ...
    businessSeedStart: 1_210_001,
    truthSeedStart: 1_410_001,
    moduleOrders: V11_AMSS_CONFIRMATORY_MODULE_ORDERS,
    ...
    evidenceGroups: V11_AMSS_CONFIRMATORY_EVIDENCE_GROUPS,
  ...
  decisions: {
    scenarios: V11_AMSS_CONFIRMATORY_DECISION_SCENARIOS,
    baseline:
  ...
  selection: {
    selector: "frozen V11 evidence-adaptive DeepSets ensemble",
    ...
    dangerPenalty: 0.5,
    comparators: [
      "frozen V9 RegretSet selector",
      "prediction-only rolling OOS selector",
  ...
  evaluation: {
    unit: "business",
    primary:
      "V11 full-coverage realized excess economic loss across the four declared decisions",
    ...
    confirmatoryDecisionRule: {
      family: "predeclared two-comparator screen; no post-truth retuning",
      primarySuccess: [
        "V11 selection objective is lower than frozen V9",
        "V11 selection objective is no higher than prediction-only",
      ],
      tailSafety:
        "V11 P95 capped risk may not exceed the better comparator P95 by more than 0.02 absolute",
      uncertainty:
        "10,000 business-level paired bootstrap resamples stratified by the four evidence groups",
      secondaryOnly: [
        "mean and P90 capped risk",
        "uncapped mean, P90, and P95 loss",
        "in-pool oracle recall and excess risk",
        "evidence-group results",
      ],
    },
  },
  orchestration: {
    ...
    truthContainerImageDigest:
      "sha256:ab78317233dd42d0391acd6b1611f451ef2616a1ed5b33fa08cf865bdcdec8a7",
    discardedPreCohortTruthImageDigest:
      "sha256:91ba93811793272189513139f98c52da0f87962e0d15bac3c9976743843b4dc6",
    projectedGrossCostUsd: [35, 45],
    operationalCostStopUsd: 50,
  },
  governance: {
    ...
    newSeedsDisjointFromPriorAmssAudit: true,
    priorAmssOutcomesUnavailableToSelection: true,
    publicationUpdateBeforeAcceptancePermitted: false,
    discardedPreCohortBuildUsedForAudit: false,
  },
} as const;
